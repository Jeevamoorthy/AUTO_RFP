...
with st.sidebar:
    ...
    if provider == "Google Gemini":
        model_list = [
            "gemini-2.5-flash", "gemini-2.5-pro", "gemini-2.0-flash", "gemini-2.0-flash-exp-image-generation",
            "gemini-2.5-preview-tts", "gemma-3-27b-it", "deep-research-pro-preview-12-2025"
        ]
            ...
            with st.expander(f"✨ {res['client']} | Mission Ready", expanded=True):
                ...
                with ca: 
                    with open(res['doc'], "rb") as f:
                        st.download_button("📥 Download Doc", f, file_name=f"Proposal_{res['file']}.docx")
                with cb:
